...
import { trendData, type TrendPoint } from '../../data/kpiMockData';
...
const TrendAnalysisGraph = ({ data = trendData, windowLabel = 'last 15 min' }: TrendAnalysisGraphProps) => {
    return (
        <div className="bg-gunmetal-900/45 backdrop-blur-md border border-gunmetal-700/70 rounded-xl p-6 h-full flex flex-col ring-1 ring-white/5">
            <div className="mb-4 flex items-center justify-between">
                <div>
                    ...
                    <p className="text-gunmetal-400 text-xs">Severity vs escalation probability ({windowLabel})</p>
                </div>
                {/* Legend */}
