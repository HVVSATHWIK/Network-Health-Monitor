        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            ...
            <div className="bg-gunmetal-900/45 backdrop-blur-md border border-gunmetal-700/70 p-4 rounded-xl flex items-center justify-between ring-1 ring-white/5">
                <div>
                    ...
                    <p className="text-alert-critical font-sans font-bold text-lg mt-1 tracking-tight">{kpiSummary.activeRootCause}</p>
                </div>
            ...
            <div className="bg-gunmetal-900/45 backdrop-blur-md border border-gunmetal-700/70 p-4 rounded-xl flex items-center justify-between ring-1 ring-white/5">
                <div>
                    ...
                    <p className="text-alert-warning font-mono font-semibold text-2xl mt-1 tabular-nums">{kpiSummary.devicesImpacted}</p>
                </div>
            ...
            <div className="bg-gunmetal-900/45 backdrop-blur-md border border-gunmetal-700/70 p-4 rounded-xl flex items-center justify-between ring-1 ring-white/5">
                <div>
                    ...
                    <p className="text-alert-success font-mono font-semibold text-2xl mt-1 tabular-nums">{kpiSummary.systemHealth}%</p>
                </div>
